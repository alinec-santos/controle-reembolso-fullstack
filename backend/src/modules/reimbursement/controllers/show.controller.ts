...
export async function showRequestController(req: Request, res: Response) {
  ...
  const user = req.user! //pega o usuario autenticadado
...
//validamos permissao aqui porque nao basta o usuario estar logado. Se um colaborador tentar acessar com id de outra pessoa , sem a validacao ele veria dados de outro colaborador
